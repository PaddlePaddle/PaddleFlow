...
```bash
+------------------+------------------+--------------+-------------------+-------------------+------------+----------------+---------------------+------------------+
|   cpu usage rate |   disk read rate |   disk usage |   disk write rate |   gpu memory util |   gpu util |   memory usage |   net receive bytes |   net send bytes |
+==================+==================+==============+===================+===================+============+================+=====================+==================+
|         0.994368 |              100 |       294912 |               100 |               100 |         90 |     0.00352478 |                 100 |               10 |
+------------------+------------------+--------------+-------------------+-------------------+------------+----------------+---------------------+------------------+
```
