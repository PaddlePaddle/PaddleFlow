...
+==========+=========+========+===================================+====================+=============================================================================================================================================================================================================================================+
| sftp1236 | root    | sftp   | 10.21.195.71:8001                 | /data2             | {'password': 'fb44e95f4f907210b7074df77f4567b6', 'user': 'pfs'}                                                                                                                                                                             |
+----------+---------+--------+-----------------------------------+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| name   | owner   | type   | server address   | sub path   | properties                                                                                                                                                                                                                                  |
+========+=========+========+==================+============+=============================================================================================================================================================================================================================================+
| s3-1   | root    | s3     | s3.bj.bcebos.com | /myfs1     | {'accessKey': '0fa8553c6a2e419ab00fad0e78482015', 'bucket': 'bml-pfstest', 'endpoint': 's3.bj.bcebos.com', 'region': 'bj', 'secretKey': '28973bfdd550af1882078074a6bab4c27d9c7456b0f4550a71269757361751f21763e2345a8764c040eb96590decd2b7'} |
+--------+---------+--------+------------------+------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
```
