...
CREATE TABLE IF NOT EXISTS `fs_cache_config` (
    ...
    `clean_cache` tinyint(1) NOT NULL COMMENT 'whether clean cache after mount pod vanishes',
    `resource` text NOT NULL COMMENT 'resource limit and request for mount pod',
