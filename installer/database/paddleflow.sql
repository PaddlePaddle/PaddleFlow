...
insert into flavour(id, name, cpu, mem, scalar_resources) values('2','flavour2', 1, '1G', '{"nvidia.com/gpu/v100_cgpu":"1"}');
insert into flavour(id, name, cpu, mem, scalar_resources) values('3','flavour3', 4, '8Gi', '{"nvidia.com/gpu/v100_cgpu":"1"}');
insert into flavour(id, name, cpu, mem, scalar_resources) values('4','flavour4', 4, '8Gi', '{"nvidia.com/gpu/v100_cgpu": "1", "nvidia.com/gpu/v100_cgpu_memory":"4G"}');
