...
func TestValidateWorkflowWithoutFs(t *testing.T) {
	...
	bwf.Source.EntryPoints.EntryPoints["data-preprocess"].(*schema.WorkflowSourceStep).Cache.FsScope = ""
	bwf.Source.EntryPoints.EntryPoints["main"].(*schema.WorkflowSourceStep).Cache.FsScope = ""
	bwf.Source.EntryPoints.EntryPoints["data-preprocess"].(*schema.WorkflowSourceStep).Cache.FsScope = ""
	bwf.Source.EntryPoints.EntryPoints["validate"].(*schema.WorkflowSourceStep).Cache.FsScope = ""
	err = bwf.validate()
	assert.Nil(t, err)
