...
const (
	...
	RegPatternRunName      = "^[A-Za-z_][A-Za-z0-9_]{1,49}[A-Za-z0-9_]$"
	RegPatternPipelineName = "^[A-Za-z_][A-Za-z0-9_]{1,49}[A-Za-z0-9_]$"
	RegPatternScheduleName = "^[A-Za-z_][A-Za-z0-9_]{1,49}[A-Za-z0-9_]$"
