...
func fillRayJobSpec(rayJobSpec *rayV1alpha1.RayJobSpec, member model.Member) {
...
func (j *RayJob) buildHeadPod(rayJobSpec *rayV1alpha1.RayJobSpec, member model.Member) error {
...
func (j *RayJob) buildWorkerPod(rayJobSpec *rayV1alpha1.RayJobSpec, member model.Member, workerIndex int, rayWorkersLength int) error {
	if member.Env == nil {
