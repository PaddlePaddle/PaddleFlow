        ...
        try:
            while True:
                ...
                if batch_idx % 5 == 0:
                    ...
                    print("Global Metrics ---> average loss: {} global auc: {} global acc: {} global mae: {} \
                        global mse: {} global rmse: {}\n".format(avg_loss,
...
print("is_server:%s", str(fleet.is_server()))
print("is_worker:%s", str(fleet.is_worker()))
...
if fleet.is_worker():
    ...
    distributed_training(exe, model, train_data_path=os.path.join(current_path, "data"))
    clear_metric_state(model, place)
    #distributed_infer(exe, model, test_data_path=os.join(current_path, "data"))
